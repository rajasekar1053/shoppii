...
const CustomSlide = ({ Subtext, imgSrc, text, buttonLink, buttonText }) => (
  <div  className="bg-[#e1e2e4]  relative flex justify-center align-center" >
 
     <div className="mr-[100px] w-[450px]" >
      
   
      <h1 className="mb-[15px] text-[2.5rem] text-[#000] font-[700]"
       
      >
        {text}
      </h1>
      <p className="mb-[25px] font-[1.5rem] text-[#666]"  > {Subtext} </p>      

      <Link to={buttonLink}>
        <button className="bg-primeColor text-white bg-[#64748b] text-lg font-bodyFont w-[185px] h-[50px] hover:bg-black duration-300 font-bold">
          {buttonText}
        </button>
      </Link>
    </div>
